...
// Stub — the enquiry detail screen is a later build.
  ...
  return (
    <SafeAreaView style={styles.screen}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Enquiry detail</Text>
      </View>
      <View style={styles.center}>
        <Feather name="message-square" size={36} color={colors.gray400} />
        <Text style={styles.title}>Enquiry #{id}</Text>
